        ...
        <div className="w-full mt-16 md:mt-0 ">
          <div className="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 mb-4 border border-2  border-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none hover:border-tranparent"
              cols={Number(30)}
              rows={Number(10)}
            ></textarea>
